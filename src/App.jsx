    ...
    <div>
      ...
      <div className='text-center space-y-3 bg-gray-50  md:px-12'>
        <div className="tabs tabs-box inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full p-1 shadow-sm ">
          ...
          <input type="radio" name="my_tabs_1" className="tab rounded-full px-6 py-2.5 text-sm font-semibold checked:bg-linear-to-r checked:from-[#4F39F6] checked:to-[#9514FA] checked:text-white" aria-label={`Cart (${carts.length})`} onClick={()=> setActiveTab("Cart")} />
        </div>
      </div>
