        ...
        <div className='max-w-4xl mx-auto p-6 md:p-10'>
            ...
            <div className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm">
                ...
                <div className='space-y-4'>
                    {carts.map(item => (
                        ...
                        <div key={item.id} className='flex items-center justify-between bg-gray-50/50 hover:bg-gray-50 p-4 md:p-6 rounded-2xl transition-colors border border-transparent hover:border-gray-100'>
                            ...
                            <button className='text-pink-500 hover:text-pink-600 font-semibold text-sm px-4 py-2 transition-opacity'>
                                Remove
                            </button>
                        </div>
                    ))}
                ...
                <div className='mt-10 pt-8 border-t border-gray-100'>
                    ...
                    <button className='w-full bg-gradient-to-r from-[#4F39F6] to-[#9514FA] hover:opacity-90 text-white py-5 rounded-2xl font-bold text-lg shadow-lg shadow-indigo-100 transition-all active:scale-[0.98]'>
                        Proceed To Checkout
                    </button>
                </div>
            </div>
